            ...
            List {
                ...
                Section {
                    ...
                    ForEach(filteredCategories) { category in
                        CategorySelectionItem(
                            name: category.name,
                            color: Color(hex: category.hexColor) ?? .accentColor,
                            isSelected: note.category?.id == category.id,
                            action: {
            ...
            List {
                ...
                Section {
                    ForEach(filteredTags) { tag in
                        TagSelectionItem(
                            tag: tag,
                            isSelected: note.tags.contains(where: { $0.id == tag.id }),
                            action: {
