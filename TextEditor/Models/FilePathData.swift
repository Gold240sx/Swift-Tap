...
class FilePathData {
    ...
    var fileExtension: String {
        (pathString as NSString).pathExtension.lowercased()
    }

    /// Parent directory path
    var parentDirectory: String {
        (pathString as NSString).deletingLastPathComponent
    }
    ...
    func refreshMetadata() {
        ...
        guard fileManager.fileExists(atPath: pathString) else { return }
